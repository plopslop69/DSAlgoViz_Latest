...
(function (t, n) {
  ...
  function r(t, n, e) {
    var r = (n - t) / Math.max(0, e),
      ...
      o = r / Math.pow(10, i);
    return i >= 0
      ? (o >= Qs ? 10 : o >= Ks ? 5 : o >= tf ? 2 : 1) * Math.pow(10, i)
      : -Math.pow(10, -i) / (o >= Qs ? 10 : o >= Ks ? 5 : o >= tf ? 2 : 1);
  }
  function i(t, n, e) {
  ...
  function f(t, n) {
    function e(e) {
      var u = null == o ? (n.ticks ? n.ticks.apply(n, i) : n.domain()) : o,
        a = null == f ? (n.tickFormat ? n.tickFormat.apply(n, i) : xf) : f,
        g = Math.max(l, 0) + p,
        y = n.range(),
        m = y[0] + 0.5,
        x = y[y.length - 1] + 0.5,
        b = (n.bandwidth ? c : xf)(n.copy()),
      ...
      (M = M.merge(
        ...
        M.attr(
          "d",
          t === Tf || t == wf
            ? "M" + d * h + "," + m + "H0.5V" + x + "H" + d * h
            : "M" + m + "," + d * h + "V0.5H" + x + "V" + d * h
        ),
    ...
    return (
      ...
      (e.tickArguments = function (t) {
        return arguments.length
          ? ((i = null == t ? [] : mf.call(t)), e)
          : i.slice();
      }),
      (e.tickValues = function (t) {
        return arguments.length
          ? ((o = null == t ? null : mf.call(t)), e)
          : o && o.slice();
      }),
  ...
  function x(t) {
    return function () {
      var n = this.ownerDocument,
        e = this.namespaceURI;
      return e === kf && n.documentElement.namespaceURI === kf
        ? n.createElement(t)
  ...
  function E(t, n, e) {
    ...
    return function (i, o, u) {
      ...
      this.addEventListener(t.type, s, e),
        (a = { type: t.type, name: t.name, value: n, listener: s, capture: e }),
  ...
  function L(t, n, e, r, i, o) {
    for (var u, a = 0, c = n.length, s = o.length; a < s; ++a)
      (u = n[a]) ? ((u.__data__ = o[a]), (r[a] = u)) : (e[a] = new P(t, o[a]));
  ...
  function R(t, n, e, r, i, o, u) {
    ...
    for (a = 0; a < l; ++a)
      (c = n[a]) &&
        ((p[a] = s = Zf + u.call(c, c.__data__, a, n)),
        s in f ? (i[a] = c) : (f[s] = c));
    for (a = 0; a < h; ++a)
      (s = Zf + u.call(t, o[a], a, o)),
        (c = f[s])
  ...
  function St(t) {
    ...
    return (
      ...
      (n = Rl.exec(t))
        ...
        ? Nt(parseInt(n[1], 16))
        : (n = Ul.exec(t))
        ? new Ct(n[1], n[2], n[3], 1)
        : (n = Dl.exec(t))
        ? new Ct((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
        : (n = Ol.exec(t))
        ? kt(n[1], n[2], n[3], n[4])
        : (n = Fl.exec(t))
        ? kt((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
        : (n = Il.exec(t))
  ...
  function Ut(t) {
    ...
    var e = Bt(t.r),
      r = Bt(t.g),
      i = Bt(t.b),
      o = Ft((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / Xl),
      u = Ft((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Vl);
    return new Ot(
      116 * u - 16,
      500 * (o - u),
      200 * (u - Ft((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / $l)),
      t.opacity
    );
  }
  function Dt(t, n, e, r) {
  ...
  function Vt(t) {
    ...
    var n = t.r / 255,
      e = t.g / 255,
      r = t.b / 255,
      i = (oh * r + rh * n - ih * e) / (oh + rh - ih),
      o = r - i,
      u = (eh * (e - i) - th * o) / nh,
      a = Math.sqrt(u * u + o * o) / (eh * i * (1 - i)),
  ...
  function Qt(t, n) {
    var e = n - t;
    return e
      ? Gt(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
      : dh(isNaN(t) ? n : t);
  }
  function Kt(t) {
    return 1 == (t = +t)
  ...
  function nn(t) {
    return function (n) {
      var e,
        ...
        a = new Array(i);
      for (e = 0; e < i; ++e)
        (r = At(n[e])), (o[e] = r.r || 0), (u[e] = r.g || 0), (a[e] = r.b || 0);
      return (
        (o = t(o)),
        (u = t(u)),
        (a = t(a)),
  ...
  function on(t) {
    return "none" === t
      ...
      : (uh ||
        ...
        (uh.style.transform = t),
        (t = ch
          .getComputedStyle(ah.appendChild(uh), null)
          .getPropertyValue("transform")),
        ah.removeChild(uh),
        (t = t.slice(7, -1).split(",")),
        Ah(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
  }
  function un(t) {
    return null == t
      ? Eh
      : (sh ||
          (sh = document.createElementNS("http://www.w3.org/2000/svg", "g")),
        sh.setAttribute("transform", t),
        (t = sh.transform.baseVal.consolidate())
          ? ((t = t.matrix), Ah(t.a, t.b, t.c, t.d, t.e, t.f))
          : Eh);
  }
  function an(t, n, e, r) {
    function i(t) {
    ...
    function u(t, n, e, o) {
      t !== n
        ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
          o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: xh(t, n) }))
        : n && e.push(i(e) + "rotate(" + n + r);
    }
    function a(t, n, e, o) {
      t !== n
        ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: xh(t, n) })
  ...
  function mn() {
    vn(), ++Yh;
    for (var t, n = fh; n; )
      (t = Vh - n._time) >= 0 && n._call.call(null, t), (n = n._next);
    --Yh;
  }
  function xn() {
  ...
  function wn() {
    for (var t, n, e = fh, r = 1 / 0; e; )
      e._call
        ? (r > e._time && (r = e._time), (t = e), (e = e._next))
        : ((n = e._next), (e._next = null), (e = t ? (t._next = n) : (fh = n)));
    (lh = t), Mn(r);
  }
  function Mn(t) {
    if (!Yh) {
      ...
      var n = t - Vh;
      n > 24
        ? (t < 1 / 0 && (Bh = setTimeout(xn, n)),
          jh && (jh = clearInterval(jh)))
        : (jh || ((Xh = Vh), (jh = setInterval(bn, Hh))), (Yh = 1), Zh(xn));
    }
  }
  function Tn(t, n) {
        ...
        if (((h = c[s]), h.name === e.name)) {
          ...
          h.state === ip
            ? ((h.state = up),
              ...
              delete c[s])
            : +s < n && ((h.state = up), h.timer.stop(), delete c[s]);
        }
      if (
        (Gh(function () {
          e.state === rp &&
            ((e.state = ip), e.timer.restart(o, e.delay, e.time), o(r));
        }),
        (e.state = ep),
        ...
        for (
          e.state = rp, a = new Array((l = e.tween.length)), s = 0, f = -1;
          s < l;
          ++s
        )
      ...
      for (
        var r =
            n < e.duration
              ...
              : (e.timer.restart(u), (e.state = op), 1),
          i = -1,
          o = a.length;
        ++i < o;
  ...
  function we(t, n) {
    for (var e; !(e = t.__transition) || !(e = e[n]); )
      if (!(t = t.parentNode)) return (Kp.time = vn()), Kp;
    return e;
  }
  function Me() {
    t.event.stopImmediatePropagation();
  ...
  function Pe(n) {
    ...
    function u() {
      ...
      function o() {
        ...
        switch (((m = O[0] - D[0]), (x = O[1] - D[1]), N)) {
          ...
          case ud:
            k &&
              ((m = Math.max(P - l, Math.min(R - v, m))),
              (h = l + m),
              (_ = v + m)),
              E &&
                ((x = Math.max(L - p, Math.min(q - g, x))),
                (d = p + x),
                (y = g + x));
            break;
          case cd:
            k < 0
              ? ((m = Math.max(P - l, Math.min(R - l, m))),
                (h = l + m),
                (_ = v))
              : k > 0 &&
                ((m = Math.max(P - v, Math.min(R - v, m))),
                (h = l),
                (_ = v + m)),
              E < 0
                ? ((x = Math.max(L - p, Math.min(q - p, x))),
                  (d = p + x),
                  (y = g))
                : E > 0 &&
                  ((x = Math.max(L - g, Math.min(q - g, x))),
                  (d = p),
                  (y = g + x));
            break;
          case sd:
            k &&
              ((h = Math.max(P, Math.min(R, l - m * k))),
              (_ = Math.max(P, Math.min(R, v + m * k)))),
              E &&
                ((d = Math.max(L, Math.min(q, p - x * E))),
                (y = Math.max(L, Math.min(q, g + x * E))));
        }
        _ < h &&
          ((k *= -1),
          (t = l),
          ...
          (h = _),
          (_ = t),
          S in dd && Y.attr("cursor", pd[(S = dd[S])])),
          y < d &&
            ((E *= -1),
            (t = p),
            (p = g),
            ...
            (d = y),
            (y = t),
            S in vd && Y.attr("cursor", pd[(S = vd[S])])),
          A.selection && (z = A.selection),
          w && ((h = z[0][0]), (_ = z[1][0])),
          M && ((d = z[0][1]), (y = z[1][1])),
          (z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === y) ||
            ((A.selection = [
              [h, d],
              [_, y],
            ]),
      ...
      function u() {
        ...
        I.attr("pointer-events", "all"),
          Y.attr("cursor", pd.overlay),
          A.selection && (z = A.selection),
          Ee(z) && ((A.selection = null), r.call(T)),
          F.end();
      }
      function a() {
      ...
      if (f.apply(this, arguments)) {
        var l,
          ...
          M,
          T = this,
          S = t.event.target.__data__.type,
          N =
            "selection" === (t.event.metaKey ? (S = "overlay") : S)
              ? ud
              : t.event.altKey
              ? sd
              : cd,
        ...
        "overlay" === S
          ? (A.selection = z =
              [
                [(l = n === ld ? P : D[0]), (p = n === fd ? L : D[1])],
                [(v = n === ld ? R : l), (g = n === fd ? q : p)],
              ])
          : ((l = z[0][0]), (p = z[0][1]), (v = z[1][0]), (g = z[1][1])),
          (h = l),
          (d = p),
          (_ = v),
          (y = g);
        var I = wl(T).attr("pointer-events", "none"),
          Y = I.selectAll(".overlay").attr("cursor", pd[S]);
        if (t.event.touches)
    ...
    return (
        ...
        t.selection
          ...
          : t.each(function () {
              var t = this,
                ...
                c = i(t, o).beforestart();
              cp(t),
                (u.selection = null == a || Ee(a) ? null : a),
                r.call(t),
                c.start().brush().end();
            });
      }),
      (o.prototype = {
        ...
        emit: function (t) {
          A(new id(e, t, n.output(this.state.selection)), l.apply, l, [
            t,
            this.that,
            this.args,
          ]);
  ...
  function dr(n) {
    return (
      (Av = Pv(n)),
      (t.format = Av.format),
      (t.formatPrefix = Av.formatPrefix),
      Av
    );
  }
  function vr() {
  ...
  function Ur(t, n) {
    ...
    if (Zv) {
      ...
      f ^ (c * Vv < s && s < c * t)
        ...
        f
          ? t < Vv
            ? Br(Bv, t) > Br(Bv, Hv) && (Hv = t)
            : Br(t, Hv) > Br(Bv, Hv) && (Bv = t)
          : Hv >= Bv
          ? (t < Bv && (Bv = t), t > Hv && (Hv = t))
          : t > Vv
          ? Br(Bv, t) > Br(Bv, Hv) && (Hv = t)
  ...
  function ui(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var s, f = i; r > 0 ? f > o : f < o; f -= c)
        (s = Er([u, -a * S_(f), -a * C_(f)])), t.point(s[0], s[1]);
    }
  }
  function ai(t, n) {
    (n = Ar(n)), (n[0] -= t), Rr(n);
  ...
  function fi(t, n, e, r) {
    ...
    return function (u) {
      ...
      function p() {
        v && (d(y, m), x && M && k.rejoin(), v.push(k.result())),
          (E.point = c),
          M && N.lineEnd();
      }
      function d(o, u) {
        ...
        if ((_ && g.push([o, u]), T))
          (y = o),
            ...
            (x = a),
            (T = !1),
            a && (N.lineStart(), N.point(o, u));
        else if (a && M) N.point(o, u);
        else {
          var c = [
              (b = Math.max(hg, Math.min(lg, b))),
              (w = Math.max(hg, Math.min(lg, w))),
            ],
            s = [
              (o = Math.max(hg, Math.min(lg, o))),
              (u = Math.max(hg, Math.min(lg, u))),
            ];
          cg(c, s, t, n, e, r)
            ? (M || (N.lineStart(), N.point(c[0], c[1])),
              N.point(s[0], s[1]),
              a || N.lineEnd(),
              (S = !1))
            : a && (N.lineStart(), N.point(o, u), (S = !1));
        }
        (b = o), (w = u), (M = a);
      }
      var v,
  ...
  function Mi() {
    ...
    function n() {
      return Js(N_(o / _) * _, i, _)
        .map(h)
        .concat(Js(N_(s / g) * g, c, g).map(p))
        .concat(
          Js(N_(r / d) * d, e, d)
            .filter(function (t) {
              return w_(t % _) > v_;
  ...
  function Xi(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - g_ - v_ : g_ - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - g_ - v_ : g_ - n[1])
    );
  }
  function Vi(t) {
    var n,
  ...
  function $i(t, n, e, r) {
    ...
    return w_(u) > v_
      ? M_(
          (C_(n) * (o = S_(r)) * C_(e) - C_(r) * (i = S_(n)) * C_(t)) /
            (i * o * u)
        )
      : (n + r) / 2;
  }
    ...
    function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
      ...
      if (m > 4 * n && v--) {
        var x = u + h,
          ...
          M = P_(x * x + b * b + w * w),
          T = yr((w /= M)),
          S = w_(w_(w) - 1) < v_ || w_(o - l) < v_ ? (o + l) / 2 : T_(b, x),
          N = t(S, T),
          k = N[0],
          E = N[1],
          A = k - r,
          ...
          z = y * A - g * C;
        ((z * z) / m > n ||
          w_((g * A + y * C) / m - 0.5) > 0.3 ||
          u * h + a * p + c * d < iy) &&
          (e(r, i, o, u, a, c, k, E, S, (x /= M), (b /= M), w, v, _),
          _.point(k, E),
          e(k, E, S, x, b, w, s, f, l, h, p, d, v, _));
      }
    }
    return function (n) {
      function r(e, r) {
  ...
  function eo(t) {
    ...
    function e(t) {
      return (
        (t = f.invert((t[0] - a) / _, (c - t[1]) / _)) && [t[0] * x_, t[1] * x_]
      );
    }
    function r(t, n) {
    ...
    return (
      ...
      (n.clipAngle = function (t) {
        return arguments.length
          ? ((S = +t ? ny((T = t * b_), 6 * b_) : ((T = null), ty)), o())
          : T * x_;
      }),
  ...
  function ho(t, n) {
    ...
    var r = S_(t),
      i = t === n ? C_(t) : E_(r / S_(n)) / E_(lo(n) / lo(t)),
      o = (r * A_(lo(t), i)) / i;
    return i
      ? ((e.invert = function (t, n) {
          var e = o - n,
  ...
  function su(t) {
    for (var n, e, r, i, o, u = new cu(t, 0), a = [u]; (n = a.pop()); )
      if ((r = n._.children))
        for (n.children = new Array((o = r.length)), i = o - 1; i >= 0; --i)
          a.push((e = n.children[i] = new cu(r[i], i))), (e.parent = n);
  ...
  function fu(t, n, e, r, i, o) {
    for (
      ...
      g.push((u = { value: f, dice: c < s, children: y.slice(m, x) })),
        u.dice
          ? Yy(u, e, r, i, w ? (r += (s * f) / w) : o)
          : Wy(u, e, r, w ? (e += (c * f) / w) : i, o),
        (w -= f),
        (m = x);
    }
    return g;
    ...
    return function (e, r) {
      t._tasks[n] &&
        ...
        null == t._error &&
          (null != e
            ? gu(t, e)
            : ((t._data[n] = r), t._waiting ? du(t) : yu(t))));
    };
  }
  function gu(t, n) {
    var e,
  ...
  function Lu(t, n) {
    function e() {
      return (
        (i = Math.min(a.length, c.length) > 2 ? zu : Cu), (o = u = null), r
      );
    }
    function r(n) {
  ...
  function Ru(t) {
    ...
    return (
      ...
      (t.nice = function (e) {
        ...
        return (
          s &&
            ((s = i(Math.floor(a / s) * s, Math.ceil(c / s) * s, u)),
            (r[0] = Math.floor(a / s) * s),
            (r[o] = Math.ceil(c / s) * s),
            n(r)),
          t
        );
  ...
  function ju() {
    function n() {
      return (
        (o = Yu(i)), (u = Iu(i)), r()[0] < 0 && ((o = Bu(o)), (u = Bu(u))), e
      );
    }
    var e = Lu(Du, Ou).domain([1, 10]),
      r = e.domain,
      i = 10,
      o = Yu(10),
      u = Iu(10);
  ...
  function Zu() {
    ...
    return (
      (t.domain = function (i) {
        return arguments.length
          ? ((n = Nm.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : n.slice();
      }),
      (t.range = function (i) {
        return arguments.length
          ? ((e = Nm.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : e.slice();
      }),
      (t.invertExtent = function (t) {
        var r = e.indexOf(t);
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            Lm.setTime(+n), Rm.setTime(+r), t(Lm), t(Rm), Math.floor(e(Lm, Rm))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  function Ju(t) {
    return Gu(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Dm) / Om
        );
      }
    );
  }
  ...
  function ea(t) {
    ...
    function e(t, n) {
      return function (e) {
        ...
        return "Z" in i
          ? ((i.H += (i.Z / 100) | 0), (i.M += i.Z % 100), ta(i))
          : n(i);
      };
    }
    function r(t, n, e, r) {
      for (var i, o, u = 0, a = n.length, c = e.length; u < a; ) {
        ...
        if (37 === (i = n.charCodeAt(u++))) {
          if (
            ((i = n.charAt(u++)),
            !(o = B[i in Ux ? n.charAt(u++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function Ga(n) {
    return (
      (Rx = ea(n)),
      (t.timeFormat = Rx.format),
      (t.timeParse = Rx.parse),
      (t.utcFormat = Rx.utcFormat),
      (t.utcParse = Rx.utcParse),
      Rx
    );
  }
  function Ja(t) {
  ...
  function Rc(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      a = (o * i + u * r) / (r + i);
    return (
      (Lc(o) + Lc(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) ||
      0
    );
  }
  function qc(t, n) {
  ...
  function es(t, n, e, r) {
    ...
    return (
      ...
      e && is(i, t, n, e),
      r && is(i, n, t, r),
      Nw[t.index].halfedges.push(o),
      Nw[n.index].halfedges.push(o),
      i
    );
  }
  function rs(t, n, e) {
  ...
  function hs() {
    for (var t, n, e, r, i = 0, o = Nw.length; i < o; ++i)
      if ((t = Nw[i]) && (r = (n = t.halfedges).length)) {
        var u = new Array(r),
          a = new Array(r);
  ...
  function _s(t) {
    var n = t.circle;
    n &&
      (n.P || (Tw = n.N), kw.remove(n), Aw.push(n), Qc(n), (t.circle = null));
  }
  function gs() {
  ...
  function xs(t) {
    ...
    for (
      ...
      (u = s.N), a.push(s), ms(s), (s = u);
    a.push(s), _s(s);
    var f,
      l = a.length;
    for (f = 1; f < l; ++f)
      (s = a[f]), (c = a[f - 1]), is(s.edge, c.site, s.site, i);
    (c = a[0]),
      (s = a[l - 1]),
      (s.edge = es(c.site, s.site, null, i)),
      vs(c),
      vs(s);
  }
  function bs(t) {
    for (var n, e, r, i, o = t[0], u = t[1], a = Sw._; a; )
      if ((r = ws(a, u) - o) > zw) a = a.L;
      else {
        if (!((i = o - Ms(a, u)) > zw)) {
          r > -zw
            ? ((n = a.P), (e = a))
    ...
    if ((Sw.insert(n, c), n || e)) {
      ...
      is(e.edge, s, d, x),
        (c.edge = es(s, t, null, x)),
        (e.edge = es(t, d, null, x)),
        vs(n),
        vs(e);
    }
  }
  ...
  function Ns(t, n) {
    var e,
      ...
      i,
      o = t.sort(Ss).pop();
    for (Ew = [], Nw = new Array(t.length), Sw = new Jc(), kw = new Jc(); ; )
      if (((i = Tw), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        (o[0] === e && o[1] === r) || (bs(o), (e = o[0]), (r = o[1])),
          (o = t.pop());
      else {
        if (!i) break;
        xs(i.arc);
  ...
  var Rs = function (t, n) {
    ...
    Fs = function (t, n) {
      null == n && (n = e);
      for (
        var r = 0, i = t.length - 1, o = t[0], u = new Array(i < 0 ? 0 : i);
        r < i;
    ...
    rf = function () {
      function t(t) {
        ...
        Array.isArray(h) ||
          ((h = i(f, l, h)),
          (h = Js(Math.ceil(f / h) * h, Math.floor(l / h) * h, h)));
        ...
        for (o = 0; o <= p; ++o)
          (d = v[o] = []),
            ...
            (d.x1 = o < p ? h[o] : l);
        for (o = 0; o < a; ++o)
          (u = c[o]), f <= u && u <= l && v[Ds(h, u, 0, p)].push(t[o]);
        return v;
      }
      var n = Gs,
        e = Xs,
      ...
      return (
        (t.value = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : Zs(e)), t)
            : n;
        }),
        (t.domain = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : Zs([n[0], n[1]])), t)
            : e;
        }),
    ...
    uf = function (t, n, e) {
      return (
        (t = Ws.call(t, Bs).sort(Rs)),
        Math.ceil(
          (e - n) /
            (2 * (of(t, 0.75) - of(t, 0.25)) * Math.pow(t.length, -1 / 3))
        )
      );
    },
    af = function (t, n, e) {
    ...
    sf = function (t, n) {
      var e,
        ...
        o = -1,
        u = 0;
      if (null == n) for (; ++o < r; ) isNaN((e = Bs(t[o]))) ? --i : (u += e);
      else for (; ++o < r; ) isNaN((e = Bs(n(t[o], o, t)))) ? --i : (u += e);
      if (i) return u / i;
    },
    ff = function (t, n) {
      var e,
        ...
        i = -1,
        o = [];
      if (null == n) for (; ++i < r; ) isNaN((e = Bs(t[i]))) || o.push(e);
      else for (; ++i < r; ) isNaN((e = Bs(n(t[i], i, t)))) || o.push(e);
      return of(o.sort(Rs), 0.5);
    },
    lf = function (t) {
    ...
    gf = function (t) {
      ...
      for (var n = -1, e = hf(t, o), r = new Array(e); ++n < e; )
  ...
  _.prototype = v.prototype = {
    ...
    on: function (t, n) {
        ...
        u = i.length;
      {
        ...
        for (; ++o < u; )
          if ((e = (t = i[o]).type) && (e = y(r[e], t.name))) return e;
      }
    },
    copy: function () {
      var t = {},
  ...
  var kf = "http://www.w3.org/1999/xhtml",
    ...
    Af = function (t) {
      ...
      return (
        ...
        Ef.hasOwnProperty(n) ? { space: Ef[n], local: t } : t
      );
    },
    Cf = function (t) {
      var n = Af(t);
  ...
  if ("undefined" != typeof document) {
    ...
    if (!Lf.matches) {
      var Rf =
        Lf.webkitMatchesSelector ||
        Lf.msMatchesSelector ||
        Lf.mozMatchesSelector ||
        Lf.oMatchesSelector;
      Pf = function (t) {
        return function () {
  ...
  if (((t.event = null), "undefined" != typeof document)) {
    "onmouseenter" in document.documentElement ||
      (Uf = { mouseenter: "mouseover", mouseleave: "mouseout" });
  }
  var Df = function (t, n, e) {
      ...
      {
        if (!(arguments.length < 2)) {
          for (a = n ? E : k, null == e && (e = !1), r = 0; r < u; ++r)
            this.each(a(o[r], n, e));
          return this;
        }
  ...
  var Wf = function (t) {
    ...
    sl = function (t, n, e) {
      ...
      return arguments.length > 1
        ? this.each(
            (null == n ? B : "function" == typeof n ? H : j)(
              t,
              n,
              null == e ? "" : e
            )
    ...
    fl = function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? X : "function" == typeof n ? $ : V)(t, n))
        : this.node()[t];
    };
  G.prototype = {
    add: function (t) {
  ...
  var ll = function (t, n) {
    ...
    pl = function (t) {
      return arguments.length
        ? this.each(null == t ? ot : ("function" == typeof t ? at : ut)(t))
        : this.node().innerHTML;
    },
    dl = function () {
      return this.each(ct);
    ...
    gl = function (t, n) {
      var e = "function" == typeof t ? t : Cf(t),
        r = null == n ? ft : "function" == typeof n ? n : Yf(n);
      return this.select(function () {
  ...
  var wl = function (t) {
      return "string" == typeof t
        ? new vt([[document.querySelector(t)]], [document.documentElement])
        : new vt([[t]], bl);
    },
    Ml = function (t) {
      return "string" == typeof t
        ? new vt([document.querySelectorAll(t)], [document.documentElement])
        : new vt([null == t ? [] : t], bl);
    },
    Tl = function (t, n, e) {
    ...
    kl = function (t) {
      var n = t.document.documentElement,
        e = wl(t).on("dragstart.drag", Nl, !0);
      "onselectstart" in n
        ? e.on("selectstart.drag", Nl, !0)
  ...
  var Al = function () {
      ...
      function o() {
        if (l.apply(this, arguments)) {
          var n,
            ...
            o = r.length;
          for (n = 0; n < o; ++n)
            (e = c(r[n].identifier, i, Tl, this, arguments)) &&
              (gt(), e("start"));
        }
      }
      function u() {
      ...
      function c(e, r, i, o, u) {
        ...
        if (
          A(
            new mt(n, "beforestart", a, e, g, f[0], f[1], 0, 0, l),
            function () {
              return (
      ...
      return (
        (n.filter = function (t) {
          return arguments.length
            ? ((l = "function" == typeof t ? t : El(!!t)), n)
            : l;
        }),
        (n.container = function (t) {
          return arguments.length
            ? ((h = "function" == typeof t ? t : El(t)), n)
            : h;
        }),
        (n.subject = function (t) {
          return arguments.length
            ? ((p = "function" == typeof t ? t : El(t)), n)
            : p;
        }),
        (n.on = function () {
    ...
    Rl = /^#([0-9a-f]{3})$/,
    ql = /^#([0-9a-f]{6})$/,
    Ul = new RegExp("^rgb\\(" + [zl, zl, zl] + "\\)$"),
    Dl = new RegExp("^rgb\\(" + [Ll, Ll, Ll] + "\\)$"),
    Ol = new RegExp("^rgba\\(" + [zl, zl, zl, Pl] + "\\)$"),
    Fl = new RegExp("^rgba\\(" + [Ll, Ll, Ll, Pl] + "\\)$"),
    Il = new RegExp("^hsl\\(" + [Pl, Ll, Ll] + "\\)$"),
    Yl = new RegExp("^hsla\\(" + [Pl, Ll, Ll, Pl] + "\\)$"),
    Bl = {
      aliceblue: 15792383,
    ...
    Mt(Tt, {
      ...
      rgb: function () {
        ...
        return (
          ...
          (e = $l * It(e)),
          new Ct(
            Yt(3.2404542 * n - 1.5371385 * t - 0.4985314 * e),
            Yt(-0.969266 * n + 1.8760108 * t + 0.041556 * e),
            Yt(0.0556434 * n - 0.2040259 * t + 1.0572252 * e),
            this.opacity
          )
        );
      },
  ...
  var uh,
    ...
    wh = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
    Mh = new RegExp(wh.source, "g"),
    Th = function (t, n) {
      var e,
        r,
        i,
        o = (wh.lastIndex = Mh.lastIndex = 0),
        u = -1,
        a = [],
        c = [];
      for (t += "", n += ""; (e = wh.exec(t)) && (r = Mh.exec(n)); )
        (i = r.index) > o &&
  ...
  gn.prototype = yn.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? vn() : +e) + (null == n ? 0 : +n)),
        this._next ||
          lh === this ||
          (lh ? (lh._next = this) : (fh = this), (lh = this)),
        (this._call = t),
        (this._time = e),
        Mn();
    },
  ...
  var Gh = function (t, n, e) {
    ...
    fp = function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = Nn(this.node(), e).tween, o = 0, u = i.length;
          o < u;
          ++o
        )
    ...
    hp = function (t, n) {
      ...
      return this.attrTween(
        t,
        "function" == typeof n
          ? (e.local ? Un : qn)(e, r, Cn(this, "attr." + t, n))
          : null == n
          ? (e.local ? Pn : zn)(e)
          : (e.local ? Rn : Ln)(e, r, n + "")
      );
    ...
    vp = function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(("function" == typeof t ? Yn : Bn)(n, t))
        ...
        for (var c, s = r[a], f = s.length, l = 0; l < f; ++l)
          if ((c = s[l])) {
            for (
              ...
              (h = p[v]) && ap(h, n, e, v, p, d);
            o.push(p), u.push(c);
          }
      return new te(o, u, n, e);
    },
    Mp = _t.prototype.constructor,
    Tp = function () {
    ...
    Sp = function (t, n, e) {
      ...
      return null == n
        ? this.styleTween(t, $n(t, r)).on("end.style." + t, Wn(t))
        : this.styleTween(
            t,
            "function" == typeof n
              ? Gn(t, r, Cn(this, "style." + t, n))
              : Zn(t, r, n + ""),
            e
          );
    },
  ...
  var zp = (function t(n) {
    ...
    Kp = { time: null, delay: 0, duration: 250, ease: se },
    td = function (t) {
      var n, e;
      t instanceof te
        ? ((n = t._id), (t = t._name))
        : ((n = ee()), ((e = Kp).time = vn()), (t = null == t ? null : t + ""));
      for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)
          (u = a[s]) && ap(u, t, n, s, a, e || we(u, n));
  ...
  var nd = [null],
    ed = function (t, n) {
      ...
      if (i) {
        n = null == n ? null : n + "";
        for (r in i)
          if ((e = i[r]).state > np && e.name === n)
            return new te([[t]], nd, n, +r);
      }
      return null;
    },
    rd = function (t) {
    ...
    hd = {
      name: "xy",
      handles: ["n", "e", "s", "w", "nw", "ne", "se", "sw"].map(Te),
      input: function (t) {
        return t;
      },
      output: function (t) {
    ...
    Sd = function () {
      function t(t) {
        ...
        for (
          ...
          (_[y] = { index: y, startAngle: a, endAngle: u, value: h[y] }),
            (u += c);
        }
        for (s = -1; ++s < l; )
          for (f = s - 1; ++f < l; ) {
      ...
      if (null === this._x1)
        ...
        if (Math.abs(f * a - c * s) > 1e-6 && i) {
          var h = e - o,
            ...
            _ = Math.sqrt(d),
            g = Math.sqrt(l),
            y = i * Math.tan((Ed - Math.acos((d + l - v) / (2 * _ * g))) / 2),
            m = y / g,
            x = y / _;
          Math.abs(m - 1) > 1e-6 &&
  ...
  var zd = function () {
    function t() {
      ...
      if (
        ...
        u.arc(0, 0, f, l, h),
        (l === _ && h === g) ||
          (u.quadraticCurveTo(0, 0, v * md(_), v * xd(_)),
          u.arc(0, 0, v, _, g)),
    ...
    return (
      (t.radius = function (n) {
        return arguments.length
          ? ((r = "function" == typeof n ? n : kd(+n)), t)
          : r;
      }),
      (t.startAngle = function (n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : kd(+n)), t)
          : i;
      }),
      (t.endAngle = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? n : kd(+n)), t)
          : o;
      }),
      (t.source = function (e) {
  ...
  var Pd = function () {
      function t(n, i, u, a) {
        ...
        for (
          var c, s, f, l = -1, h = n.length, p = o[i++], d = Be(), v = u();
          ++l < h;
  ...
  var Rd = function (t) {
    ...
    uv = function (t) {
      var n,
        ...
        c = this._root;
      for (
        c && a.push(new nv(c, this._x0, this._y0, this._x1, this._y1));
        (n = a.pop());
        ...
        if (
          ...
          var s = (r + o) / 2,
            f = (i + u) / 2;
          (e = c[3]) && a.push(new nv(e, s, f, o, u)),
            (e = c[2]) && a.push(new nv(e, r, f, s, u)),
            (e = c[1]) && a.push(new nv(e, s, i, o, f)),
            (e = c[0]) && a.push(new nv(e, r, i, s, f));
        }
      return this;
    },
    av = function (t) {
      ...
      for (
        this._root &&
        e.push(new nv(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            f = (u + c) / 2,
            l = (a + s) / 2;
          (o = i[0]) && e.push(new nv(o, u, a, f, l)),
            (o = i[1]) && e.push(new nv(o, f, a, c, l)),
            (o = i[2]) && e.push(new nv(o, u, l, f, s)),
            (o = i[3]) && e.push(new nv(o, f, l, c, s));
        }
        r.push(n);
      }
  ...
  (fv.copy = function () {
    var t,
      n,
      e = new ir(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
      r = this._root;
    if (!r) return e;
  ...
  var lv,
    hv = function (t) {
      function n() {
        ...
        for (var n, r, c, s, f, l, h, p = i.length, d = 0; d < a; ++d)
          for (r = rr(i, ur, ar).visitAfter(e), n = 0; n < p; ++n)
            (c = i[n]),
              (l = o[c.index]),
              (h = l * l),
              (s = c.x + c.vx),
      ...
      var i,
        ...
        a = 1;
      return (
        "function" != typeof t && (t = Zd(null == t ? 1 : +t)),
        ...
        (n.radius = function (e) {
          return arguments.length
            ? ((t = "function" == typeof e ? e : Zd(+e)), r(), n)
            : t;
        }),
        n
      );
    ...
    pv = function (t) {
        ...
        for (var e = 0, r = t.length; e < d; ++e)
          for (var i, o, c, s, l, h, p, v = 0; v < r; ++v)
            (i = t[v]),
              (o = i.source),
              (c = i.target),
              (s = c.x + c.vx - o.x - o.vx || Gd()),
              (l = c.y + c.vy - o.y - o.vy || Gd()),
              (h = Math.sqrt(s * s + l * l)),
              (h = ((h - a[v]) / h) * n * u[v]),
              (s *= h),
              (l *= h),
      ...
      return (
        ...
        (e.strength = function (t) {
          return arguments.length
            ? ((h = "function" == typeof t ? t : Zd(+t)), i(), e)
            : h;
        }),
        (e.distance = function (t) {
          return arguments.length
            ? ((p = "function" == typeof t ? t : Zd(+t)), o(), e)
            : p;
        }),
        e
      );
    ...
    gv = function () {
      ...
      return (
        ...
        (t.strength = function (e) {
          return arguments.length
            ? ((c = "function" == typeof e ? e : Zd(+e)), n(), t)
            : c;
        }),
    ...
    yv = function (t) {
      ...
      var r,
        ...
        u = Zd(0.1);
      return (
        "function" != typeof t && (t = Zd(null == t ? 0 : +t)),
        (n.initialize = function (t) {
          (r = t), e();
        }),
        (n.strength = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : Zd(+t)), e(), n)
            : u;
        }),
        (n.x = function (r) {
          return arguments.length
            ? ((t = "function" == typeof r ? r : Zd(+r)), e(), n)
            : t;
        }),
        n
      );
    ...
    Sv = function (t, n) {
      ...
      var r = e[0],
        i = e[1],
        o = i - (lv = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
        u = r.length;
      return o === u
        ? r
        : o > u
        ...
        : "0." + new Array(1 - o).join("0") + xv(t, Math.max(0, n + o - 1))[0];
    },
    Nv = function (t, n) {
      var e = xv(t, n);
      if (!e) return t + "";
  ...
  var Av,
    ...
    Pv = function (t) {
      function n(t) {
        function n(t) {
            ...
            if (
              ...
              for (n = -1, i = t.length; ++n < i; )
                if (48 > (a = t.charCodeAt(n)) || a > 57) {
                  (x = (46 === a ? o + t.slice(n + 1) : t.slice(n)) + x),
                    (t = t.slice(0, n));
                  break;
                }
          }
          ...
          switch (
            (p &&
              l &&
              ((t = r(M + t, M.length ? h - x.length : 1 / 0)), (M = "")),
            c)
          ) {
            case "<":
              t = f + t + x + M;
      ...
      function e(t, e) {
        var r = n(((t = hr(t)), (t.type = "f"), t)),
          i = 3 * Math.max(-8, Math.min(8, Math.floor(bv(e) / 3))),
          o = Math.pow(10, -i),
          u = zv[8 + i / 3];
        return function (t) {
          return r(o * t) + u;
      ...
      var r = t.grouping && t.thousands ? wv(t.grouping, t.thousands) : Cv,
        i = t.currency,
        o = t.decimal,
        u = t.numerals ? Mv(t.numerals) : Cv,
        a = t.percent || "%";
  ...
  var Lv = function (t) {
    ...
    Rv = function (t, n) {
      return Math.max(
        0,
        3 * Math.max(-8, Math.min(8, Math.floor(bv(n) / 3))) - bv(Math.abs(t))
      );
    },
    qv = function (t, n) {
      return (
        (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, bv(n) - bv(t)) + 1
      );
    },
    Uv = function () {
      return new vr();
  ...
  vr.prototype = {
    ...
    add: function (t) {
      _r(d_, t, this.t),
        _r(this, d_.s, this.s),
        this.s ? (this.t += d_.t) : (this.s = d_.t);
    },
    valueOf: function () {
      return this.s;
    },
  ...
  var Dv,
    ...
    F_ = {
      ...
      polygonEnd: function () {
        var t = +D_;
        O_.add(t < 0 ? m_ + t : t),
          (this.lineStart = this.lineEnd = this.point = xr);
      },
      sphere: function () {
        O_.add(m_);
      },
    ...
    j_ = function (t) {
      var n, e, r, i, o, u, a;
      if (
        ((Xv = Hv = -(Bv = jv = 1 / 0)), (Gv = []), U_(t, B_), (e = Gv.length))
      ) {
        for (Gv.sort(jr), n = 1, r = Gv[0], o = [r]; n < e; ++n)
          (i = Gv[n]),
            Hr(r, i[0]) || Hr(r, i[1])
              ? (Br(r[0], i[1]) > Br(r[0], r[1]) && (r[1] = i[1]),
                Br(i[0], r[1]) > Br(r[0], r[1]) && (r[0] = i[0]))
              : o.push((r = i));
        for (u = -1 / 0, e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n)
          (i = o[n]),
            (a = Br(r[1], i[0])) > u && ((u = a), (Bv = i[0]), (Hv = r[1]));
      }
      return (
        (Gv = Jv = null),
        Bv === 1 / 0 || jv === 1 / 0
    ...
    X_ = function (t) {
      ...
      return i < 1e-12 &&
        ...
        (e = i_),
        (r = o_),
        Kv < v_ && ((n = t_), (e = n_), (r = e_)),
        (i = n * n + e * e + r * r) < 1e-12)
        ? [NaN, NaN]
        : [T_(e, n) * x_, yr(r / P_(i)) * x_];
    },
    V_ = function (t) {
      return function () {
        return t;
  ...
  var W_,
    ...
    og = function (t) {
      ...
      return (
        (t = ei(t[0] * b_, t[1] * b_, t.length > 2 ? t[2] * b_ : 0)),
        (n.invert = function (n) {
          return (
            (n = t.invert(n[0] * b_, n[1] * b_)), (n[0] *= x_), (n[1] *= x_), n
          );
        }),
        n
      );
    ...
    ug = function () {
      ...
      function n() {
        var t = i.apply(this, arguments),
          n = o.apply(this, arguments) * b_,
          c = u.apply(this, arguments) * b_;
        return (
          (e = []),
          (r = ei(-t[0] * b_, -t[1] * b_, 0).invert),
          ui(a, n, c, 1),
      ...
      return (
        (n.center = function (t) {
          return arguments.length
            ? ((i = "function" == typeof t ? t : V_([+t[0], +t[1]])), n)
            : i;
        }),
        (n.radius = function (t) {
          return arguments.length
            ? ((o = "function" == typeof t ? t : V_(+t)), n)
            : o;
        }),
        (n.precision = function (t) {
          return arguments.length
            ? ((u = "function" == typeof t ? t : V_(+t)), n)
            : u;
        }),
        n
      );
      ...
      if (
        (t.forEach(function (t) {
          if (!((n = t.length - 1) <= 0)) {
            ...
            a.push((e = new ci(r, t, null, !0))),
              c.push((e.o = new ci(r, null, e, !1))),
              a.push((e = new ci(u, t, null, !1))),
              c.push((e.o = new ci(u, null, e, !0)));
          }
        }),
        a.length)
      ) {
        for (c.sort(n), si(a), si(c), o = 0, u = c.length; o < u; ++o)
          c[o].e = e = !e;
        for (var s, f, l = a[0]; ; ) {
    ...
    mg = [null, null],
    xg = { type: "LineString", coordinates: mg },
    bg = function (t, n) {
      ...
      switch (this._point) {
        ...
        default:
          this._context.moveTo(t + this._radius, n),
            this._context.arc(t, n, this._radius, 0, m_);
      }
    },
    result: xr,
  };
  ...
  var Qg = function (t, n) {
      ...
      return (
        ...
        (e.projection = function (n) {
          return arguments.length
            ? ((r = null == n ? ((t = null), Ng) : (t = n).stream), e)
            : t;
        }),
        (e.context = function (t) {
          return arguments.length
            ? ((i = null == t ? ((n = null), new Bi()) : new Fi((n = t))),
        ...
        var p,
          ...
          b = {
            ...
            polygonEnd: function () {
              ...
              var t = vg(p, g);
              d.length
                ? (x || (o.polygonStart(), (x = !0)), fg(d, Xi, t, e, o))
                : t &&
        ...
        return {
          ...
          point: function (l, h) {
            var p,
              d = [l, h],
              v = r(l, h),
              _ = c ? (v ? 0 : u(l, h)) : v ? u(l + (l < 0 ? __ : -__), h) : 0;
            if (
              (!n && (a = i = v) && t.lineStart(),
              v !== i &&
                ((p = o(n, d)),
                (sg(n, p) || sg(d, p)) &&
                  ((d[0] += v_), (d[1] += v_), (v = r(d[0], d[1])))),
              v !== i)
            )
              (f = 0),
                v
  ...
  var ry = 16,
    ...
    sy = function () {
      ...
      var e,
        ...
        a,
        c = cy(),
        s = ay().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
        f = ay().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
        l = {
          point: function (t, n) {
            a = [t, n];
          },
      ...
      return (
        ...
        (t.stream = function (t) {
          return e && r === t
            ? e
            : (e = uo([c.stream((r = t)), s.stream(t), f.stream(t)]));
        }),
        ...
        (t.translate = function (t) {
          ...
          return (
            ...
            (o = s
              ...
              .clipExtent([
                [r - 0.425 * e + v_, a + 0.12 * e + v_],
                [r - 0.214 * e - v_, a + 0.234 * e - v_],
              ])
              .stream(l)),
            (u = f
              .translate([r - 0.205 * e, a + 0.212 * e])
              .clipExtent([
                [r - 0.214 * e + v_, a + 0.166 * e + v_],
                [r - 0.115 * e - v_, a + 0.234 * e - v_],
              ])
              .stream(l)),
            n()
          );
  ...
  var yy = function () {
    ...
    my = function () {
      ...
      return (u = {
        ...
        scale: function (n) {
          return arguments.length
            ? ((h = go((a = +n) * f, a * l, c, s)), t())
            : a;
        },
        translate: function (n) {
          return arguments.length
            ? ((h = go(a * f, a * l, (c = +n[0]), (s = +n[1]))), t())
            : [c, s];
        },
        reflectX: function (n) {
          return arguments.length
            ? ((h = go(a * (f = n ? -1 : 1), a * l, c, s)), t())
            : f < 0;
        },
        reflectY: function (n) {
          return arguments.length
            ? ((h = go(a * f, a * (l = n ? -1 : 1), c, s)), t())
            : l < 0;
        },
  ...
  var wy = function () {
    ...
    Cy = function (t) {
      for (var n = this, e = Ao(n, t), r = [n]; n !== e; )
        (n = n.parent), r.push(n);
  ...
  var qy = function (t) {
    ...
    Fy = function () {
      function t(t) {
        return (
          ...
          (t.y = r / 2),
          n
            ? t.eachBefore(Jo(n)).eachAfter(Qo(i, 0.5)).eachBefore(Ko(1))
            : t
                .eachBefore(Jo(Go))
                .eachAfter(Qo(Zo, 1))
                .eachAfter(Qo(i, t.r / Math.min(e, r)))
    ...
    By = function () {
      ...
      function n(t, n) {
        return function (e) {
          e.children &&
            Yy(e, e.x0, (t * (e.depth + 1)) / n, e.x1, (t * (e.depth + 2)) / n);
          var r = e.x0,
            o = e.y0,
            u = e.x1 - i,
            a = e.y1 - i;
        ...
        if (n) {
          for (
            ...
            (c = ru(c)),
              ...
              r > 0 && (ou(au(a, t, e), t, r), (s += r), (f += r)),
              (l += a.m),
              (s += i.m),
              (h += c.m),
              (f += u.m);
          a && !iu(u) && ((u.t = a), (u.m += l - f)),
            i && !ru(c) && ((c.t = i), (c.m += s - h), (e = t));
        }
        return e;
      }
      function i(t) {
    ...
    Jy = function () {
      ...
      return (
        ...
        (t.paddingTop = function (n) {
          return arguments.length
            ? ((c = "function" == typeof n ? n : Oy(+n)), t)
            : c;
        }),
        (t.paddingRight = function (n) {
          return arguments.length
            ? ((s = "function" == typeof n ? n : Oy(+n)), t)
            : s;
        }),
        (t.paddingBottom = function (n) {
          return arguments.length
            ? ((f = "function" == typeof n ? n : Oy(+n)), t)
            : f;
        }),
        (t.paddingLeft = function (n) {
          return arguments.length
            ? ((l = "function" == typeof n ? n : Oy(+n)), t)
            : l;
        }),
        t
      );
        ...
        if ((u = t._squarify) && u.ratio === n)
          for (
            ...
            for (
              ...
              a.value += c[s].value;
            a.dice
              ? Yy(a, e, r, i, (r += ((o - r) * a.value) / p))
              : Wy(a, e, r, (e += ((i - e) * a.value) / p), o),
              (p -= a.value);
          }
  ...
  var sm = function (t, n) {
    ...
    wm = bm("text/csv", Fd),
    Mm = bm("text/tab-separated-values", Hd),
    Tm = Array.prototype,
    Sm = Tm.map,
    Nm = Tm.slice,
    km = { name: "implicit" },
    ...
    zm = function (n, e, r) {
      ...
      switch (((r = hr(null == r ? ",f" : r)), r.type)) {
        case "s":
          ...
          return (
            null != r.precision || isNaN((o = Rv(c, s))) || (r.precision = o),
            t.formatPrefix(r, s)
          );
        case "":
        case "e":
        ...
        case "r":
          null != r.precision ||
            isNaN((o = qv(c, Math.max(Math.abs(u), Math.abs(a))))) ||
  ...
  var Um = qm.range,
    ...
    Xm = Gu(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * Dm) / 864e5
        );
      },
      function (t) {
        return t.getDate() - 1;
  ...
  var Ix = Date.prototype.toISOString
    ...
    Yx = +new Date("2000-01-01T00:00:00.000Z")
      ? Qa
    ...
    Wx = 365 * Xx,
    Zx = function () {
      return nc(sx, ax, $m, Xm, jm, Ym, Fm, qm, t.timeFormat).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2),
      ]);
    },
    Gx = function () {
      return nc(Lx, zx, gx, vx, px, lx, Fm, qm, t.utcFormat).domain([
        Date.UTC(2e3, 0, 1),
        Date.UTC(2e3, 0, 2),
      ]);
    },
    ...
    eb = Fh($t(300, 0.5, 0), $t(-240, 0.5, 1)),
    rb = Fh($t(-100, 0.75, 0.35), $t(80, 1.5, 0.8)),
    ib = Fh($t(260, 0.75, 0.35), $t(80, 1.5, 0.8)),
    ob = $t(),
    ub = function (t) {
    ...
    Mb = function () {
      function t() {
        var t,
          ...
          h = o.apply(this, arguments) - bb,
          p = u.apply(this, arguments) - bb,
          d = hb(p - h),
          v = p > h;
        if ((c || (c = t = qe()), l < f && ((s = l), (l = f), (f = s)), l > mb))
          if (d > wb - mb)
            c.moveTo(l * db(h), l * gb(h)),
              c.arc(0, 0, l, h, p, !v),
              f > mb &&
                (c.moveTo(f * db(p), f * gb(p)), c.arc(0, 0, f, p, h, v));
          else {
            var _,
              g,
              y = h,
              ...
              N = _b(hb(l - f) / 2, +r.apply(this, arguments)),
              k = N,
              E = N;
            if (S > mb) {
              var A = oc((S / f) * gb(T)),
            ...
            if (N > mb) {
              var q = l * db(m),
                ...
                O = f * gb(x);
              if (d < xb) {
                var F = w > mb ? lc(z, P, D, O, q, U, L, R) : [L, R],
                  I = z - F[0],
                  Y = P - F[1],
                  B = q - F[0],
                  j = U - F[1],
            ...
            M > mb
              ? E > mb
                  ...
                  E < N
                    ...
                    : (c.arc(
                      ...
                      c.arc(
                        ...
                        0,
                        l,
                        pb(_.cy + _.y11, _.cx + _.x11),
                        pb(g.cy + g.y11, g.cx + g.x11),
                        !v
                      ),
                      c.arc(
                        g.cx,
                ...
                : (c.moveTo(z, P), c.arc(0, 0, l, y, m, !v))
              : c.moveTo(z, P),
              f > mb && w > mb
                ? k > mb
                  ? ((_ = hc(L, R, q, U, f, -k, v)),
      ...
      return (
        ...
        (t.innerRadius = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : lb(+e)), t)
            : n;
        }),
        (t.outerRadius = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : lb(+n)), t)
            : e;
        }),
        (t.cornerRadius = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : lb(+n)), t)
            : r;
        }),
        (t.padRadius = function (n) {
          return arguments.length
            ? ((i = null == n ? null : "function" == typeof n ? n : lb(+n)), t)
            : i;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : lb(+n)), t)
            : o;
        }),
        (t.endAngle = function (n) {
          return arguments.length
            ? ((u = "function" == typeof n ? n : lb(+n)), t)
            : u;
        }),
        (t.padAngle = function (n) {
          return arguments.length
            ? ((a = "function" == typeof n ? n : lb(+n)), t)
            : a;
        }),
        (t.context = function (n) {
  ...
  var Tb = function (t) {
    ...
    Nb = function () {
      ...
      return (
        (t.x = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : lb(+n)), (r = null), t)
            : e;
        }),
        (t.x0 = function (n) {
          return arguments.length
        ...
        (t.x1 = function (n) {
          return arguments.length
            ? ((r = null == n ? null : "function" == typeof n ? n : lb(+n)), t)
            : r;
        }),
        (t.y = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : lb(+n)), (o = null), t)
            : i;
        }),
        (t.y0 = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : lb(+n)), t)
            : i;
        }),
        (t.y1 = function (n) {
          return arguments.length
            ? ((o = null == n ? null : "function" == typeof n ? n : lb(+n)), t)
            : o;
        }),
        (t.lineX0 = t.lineY0 =
          function () {
  ...
  var zb = function () {
    ...
    Ob = Math.sin(xb / 10) / Math.sin((7 * xb) / 10),
    Fb = Math.sin(wb / 10) * Ob,
    Ib = -Math.cos(wb / 10) * Ob,
    Yb = {
      draw: function (t, n) {
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = jc(t), i = jc(n), o = 0, u = 1; u < e; ++o, ++u)
  ...
  var lw = function (t) {
    ...
    vw = function () {
      ...
      return (
        (t.keys = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : lb(hw.call(e))), t)
            : n;
        }),
        (t.value = function (n) {
          return arguments.length
        ...
        (t.order = function (n) {
          return arguments.length
            ? ((e =
                null == n ? dw : "function" == typeof n ? n : lb(hw.call(n))),
              t)
            : e;
        }),
        (t.offset = function (n) {
      ...
      if (
        ...
        do {
          ...
          if (t === i.L) {
            if (
              ((n = i.R),
              n.C && ((n.C = !1), (i.C = !0), Kc(this, i), (n = i.R)),
              (n.L && n.L.C) || (n.R && n.R.C))
            ) {
              (n.R && n.R.C) ||
                ((n.L.C = !1), (n.C = !0), ts(this, n), (n = i.R)),
                (n.C = i.C),
                (i.C = n.R.C = !1),
                Kc(this, i),
                (t = this._);
            ...
            ((n = i.L),
            n.C && ((n.C = !1), (i.C = !0), ts(this, i), (n = i.L)),
            (n.L && n.L.C) || (n.R && n.R.C))
          ) {
            (n.L && n.L.C) ||
              ((n.R.C = !1), (n.C = !0), Kc(this, n), (n = i.L)),
              (n.C = i.C),
              (i.C = n.L.C = !1),
              ts(this, i),
              (t = this._);
  ...
  Es.prototype = {
    ...
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new Es(this.k, this.x + this.k * t, this.y + this.k * n);
    },
    apply: function (t) {
  ...
  var Uw = function () {
    ...
    Dw = function () {
      ...
      function e(t, n) {
        return (
          (n = Math.max(x, Math.min(b, n))), n === t.k ? t : new Es(n, t.x, t.y)
        );
      }
      function r(t, n, e) {
        var r = n[0] - e[0] * t.k,
        ...
        function n() {
          Uw(),
            ...
            o.zoom(
              "mouse",
              i(
                r(o.that.__zoom, (o.mouse[0] = If(o.that)), o.mouse[1]),
                o.extent
              )
            );
        }
      ...
      function l() {
        if (y.apply(this, arguments)) {
          ...
          Uw(),
            N > 0
              ? wl(this).transition().duration(N).call(u, f, a)
              : wl(this).call(n.transform, f);
        }
      }
      function h() {
        if (y.apply(this, arguments)) {
          ...
          for (Cs(), e = 0; e < c; ++e)
            (r = u[e]),
              (i = Tl(this, u, r.identifier)),
              (i = [i, this.__zoom.invert(i), r.identifier]),
              o.touch0
                ? o.touch1 || (o.touch1 = i)
                : ((o.touch0 = i), (n = !0));
          if (_ && ((_ = clearTimeout(_)), !o.touch1))
            return (
              o.end(),
              void (
                (i = wl(this).on("dblclick.zoom")) && i.apply(this, arguments)
              )
            );
          n &&
      ...
      return (
        ...
        (n.scaleTo = function (t, u) {
          n.transform(t, function () {
            ...
            return i(
              r(
                e(n, "function" == typeof u ? u.apply(this, arguments) : u),
                a,
                c
              ),
              t
        ...
        (c.prototype = {
          ...
          zoom: function (t, n) {
            ...
            return (
              0 == --this.active &&
                (E.splice(this.index, 1), (this.index = -1), this.emit("end")),
              this
            );
          },
          emit: function (t) {
            A(new ks(n, t, this.that.__zoom), C.apply, C, [
              t,
              this.that,
              this.args,
            ]);
  ...
  (t.version = "4.8.0"),
    ...
    (t.extent = Xs),
    (t.histogram = rf),
    (t.thresholdFreedmanDiaconis = uf),
    (t.thresholdScott = af),
    ...
    (t.easeElasticIn = Gp),
    (t.easeElasticOut = Jp),
    (t.easeElasticInOut = Qp),
    (t.forceCenter = Wd),
    (t.forceCollide = hv),
    (t.forceLink = pv),
    (t.forceManyBody = gv),
    (t.forceSimulation = _v),
    (t.forceX = yv),
    (t.forceY = mv),
    (t.formatDefaultLocale = dr),
    (t.formatLocale = Pv),
    (t.formatSpecifier = hr),
    (t.precisionFixed = Lv),
    ...
    (t.geoAlbers = cy),
    (t.geoAlbersUsa = sy),
    (t.geoAzimuthalEqualArea = ly),
    (t.geoAzimuthalEqualAreaRaw = fy),
    (t.geoAzimuthalEquidistant = py),
    (t.geoAzimuthalEquidistantRaw = hy),
    (t.geoConicConformal = vy),
    (t.geoConicConformalRaw = ho),
    (t.geoConicEqualArea = ay),
    (t.geoConicEqualAreaRaw = oo),
    (t.geoConicEquidistant = gy),
    (t.geoConicEquidistantRaw = vo),
    (t.geoEquirectangular = _y),
    (t.geoEquirectangularRaw = po),
    (t.geoGnomonic = yy),
    (t.geoGnomonicRaw = _o),
    (t.geoIdentity = my),
    (t.geoProjection = no),
    (t.geoProjectionMutator = eo),
    (t.geoMercator = dy),
    (t.geoMercatorRaw = so),
    (t.geoOrthographic = xy),
    (t.geoOrthographicRaw = yo),
    (t.geoStereographic = by),
    (t.geoStereographicRaw = mo),
    (t.geoTransverseMercator = wy),
    (t.geoTransverseMercatorRaw = xo),
    (t.geoRotation = og),
    (t.geoStream = U_),
    (t.geoTransform = ey),
    (t.cluster = My),
    ...
    (t.treemapDice = Yy),
    (t.treemapSlice = Wy),
    (t.treemapSliceDice = Ky),
    (t.treemapSquarify = Gy),
    (t.treemapResquarify = tm),
    (t.interpolate = Sh),
    (t.interpolateArray = yh),
    (t.interpolateBasis = hh),
    (t.interpolateBasisClosed = ph),
    (t.interpolateDate = mh),
    (t.interpolateNumber = xh),
    (t.interpolateObject = bh),
    (t.interpolateRound = Nh),
    (t.interpolateString = Th),
    (t.interpolateTransformCss = Ch),
    (t.interpolateTransformSvg = zh),
    (t.interpolateZoom = Lh),
    (t.interpolateRgb = vh),
    (t.interpolateRgbBasis = _h),
    (t.interpolateRgbBasisClosed = gh),
    (t.interpolateHsl = Rh),
    (t.interpolateHslLong = qh),
    (t.interpolateLab = hn),
    (t.interpolateHcl = Uh),
    (t.interpolateHclLong = Dh),
    (t.interpolateCubehelix = Oh),
    (t.interpolateCubehelixLong = Fh),
    (t.quantize = Ih),
    (t.path = qe),
    (t.polygonArea = nm),
    (t.polygonCentroid = em);
  (t.polygonHull = im),
    (t.polygonContains = om),
    (t.polygonLength = um),
    (t.quadtree = rr),
    (t.queue = mu),
    (t.randomUniform = sm),
    (t.randomNormal = fm),
    (t.randomLogNormal = lm),
    (t.randomBates = pm),
    (t.randomIrwinHall = hm),
    (t.randomExponential = dm),
    (t.request = vm),
    (t.html = gm),
    (t.json = ym),
    (t.text = mm),
    ...
    (t.scaleTime = Zx),
    (t.scaleUtc = Gx),
    (t.schemeCategory10 = Qx),
    (t.schemeCategory20b = Kx),
    (t.schemeCategory20c = tb),
    (t.schemeCategory20 = nb),
    (t.interpolateCubehelixDefault = eb),
    (t.interpolateRainbow = ub),
    (t.interpolateWarm = rb),
    (t.interpolateCool = ib),
    (t.interpolateViridis = ab),
    (t.interpolateMagma = cb),
    (t.interpolateInferno = sb),
    (t.interpolatePlasma = fb),
    (t.scaleSequential = rc),
    (t.creator = Cf),
    (t.local = w),
    (t.matcher = qf),
    (t.mouse = If),
    ...
    (t.curveStep = lw),
    (t.curveStepAfter = Vc),
    (t.curveStepBefore = Xc),
    (t.stack = vw),
    (t.stackOffsetExpand = _w),
    (t.stackOffsetNone = pw),
    (t.stackOffsetSilhouette = gw),
    (t.stackOffsetWiggle = yw),
    ...
    (t.timeInterval = Gu),
    (t.timeMillisecond = qm),
    (t.timeMilliseconds = Um),
    (t.utcMillisecond = qm),
    (t.utcMilliseconds = Um),
    (t.timeSecond = Fm),
    (t.timeSeconds = Im),
    (t.utcSecond = Fm),
    (t.utcSeconds = Im),
    ...
    (t.utcYear = Lx),
    (t.utcYears = qx),
    (t.timeFormatDefaultLocale = Ga),
    (t.timeFormatLocale = ea),
    (t.isoFormat = Ix),
    (t.isoParse = Yx),
    (t.now = vn),
    (t.timer = yn),
